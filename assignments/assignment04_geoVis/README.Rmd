...
The median income for Louisiana is `r dollar(as.numeric(dt[dt$state %in% 'Louisiana', 'median_household_income']))` and the Gini-Index is `r dt[dt$state %in% 'Louisiana', 'gini_index']`.