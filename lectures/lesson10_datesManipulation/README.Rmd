...
dt %>%
  mutate(isNight = case_when(between(offensetime_discrete, 20:00:00, 5:00:00) ~ 'night', between(offensetime_discrete, 5:00:00, 10:30:00) ~ 'morning', between(offensetime_discrete, 10:30:00, 14:00:00) ~ 'day', between(offensetime_discrete, 14:00:00, 17:30:00) ~ 'afternoon', T ~ 'evening'))
```
