---
title: "Interactive Dashboards with Flexdashboard"
...
Dashboards are often used for exploratory analysis or monitoring, but they can be quite effective tools for telling _your_ data-driven story. For example, the using [story-board menus](https://beta.rstudioconnect.com/jjallaire/htmlwidgets-showcase-storyboard/htmlwidgets-showcase-storyboard.html) is a very valid alternative to powerpoint presentations.
